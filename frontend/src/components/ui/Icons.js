...
export function GraduationCapIcon({ className = 'w-10 h-10' }) {
  return (
...
export function AlertTriangleIcon({ className = 'w-12 h-12' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function FaceFrownIcon({ className = 'w-14 h-14' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function TagIcon({ className = 'w-12 h-12' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function SparklesIcon({ className = 'w-14 h-14' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
